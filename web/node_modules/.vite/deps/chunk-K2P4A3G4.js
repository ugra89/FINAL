...
function useDropdown(parameters = {}) {
  ...
  const [popupId, setPopupId] = React44.useState("");
  const [triggerElement, setTriggerElement] = React44.useState(null);
  const lastActionType = React44.useRef(null);
  const handleStateChange = React44.useCallback((event, field, value, reason) => {
    if (field === "open") {
      onOpenChange == null ? void 0 : onOpenChange(event, value);
    }
    lastActionType.current = reason;
  }, [onOpenChange]);
  const controlledProps = React44.useMemo(() => openProp !== void 0 ? {
    open: openProp
  } : {}, [openProp]);
...
function Dropdown(props) {
  ...
  return (0, import_jsx_runtime27.jsx)(DropdownContext_default.Provider, {
    value: contextValue,
    children
  });
}
true ? Dropdown.propTypes = {
   ...
   */
  onOpenChange: import_prop_types28.default.func,
  /**
...
var FormControl = React47.forwardRef(function FormControl2(props, forwardedRef) {
  var _slots$root;
  const {
    defaultValue,
    children,
  ...
  React47.useEffect(() => setFocused((isFocused) => disabled ? false : isFocused), [disabled]);
  const ownerState = _extends({}, props, {
    disabled,
    error,
    filled,
...
var Input = React50.forwardRef(function Input2(props, forwardedRef) {
...
function useSelectChangeNotifiers() {
  ...
  const notifySelectionChanged = React52.useCallback((newSelectedItems) => {
    messageBus.publish(SELECTION_CHANGE_TOPIC, newSelectedItems);
  }, [messageBus]);
  const notifyHighlightChanged = React52.useCallback((newHighlightedItem) => {
...
function useForcedRerendering() {
  const [, setState] = React56.useState({});
  return React56.useCallback(() => {
    setState({});
  }, []);
}
...
var ListContext = React57.createContext(null);
if (true) {
...
function useListItem(parameters) {
  ...
  const createHandleClick = React58.useCallback((other) => (event) => {
    var _other$onClick;
  ...
  const createHandlePointerOver = React58.useCallback((other) => (event) => {
...
var CompoundComponentContext = React59.createContext(null);
...
function useCompoundParent() {
  const [subitems, setSubitems] = React59.useState(/* @__PURE__ */ new Map());
  const subitemKeys = React59.useRef(/* @__PURE__ */ new Set());
  const deregisterItem = React59.useCallback(function deregisterItem2(id) {
  ...
  const registerItem = React59.useCallback(function registerItem2(id, item) {
  ...
  const sortedSubitems = React59.useMemo(() => sortSubitems(subitems), [subitems]);
  const getItemIndex = React59.useCallback(function getItemIndex2(id) {
...
function useMenu(parameters = {}) {
  ...
  const {
    ...
    triggerElement,
    registerPopup
  } = (_React$useContext = React60.useContext(DropdownContext_default)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT;
...
var _excluded26 = ["actions", "children", "onItemsChange", "slotProps", "slots"];
...
var Menu = React62.forwardRef(function Menu2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime32.jsx)(Popper_default, _extends({}, rootProps, {
    open,
...
function useMenuButton(parameters = {}) {
  ...
  const menuContext = React63.useContext(DropdownContext_default);
  if (menuContext === null) {
...
var _excluded27 = ["children", "disabled", "label", "slots", "slotProps", "focusableWhenDisabled"];
...
function useCompoundItem(id, itemMetadata) {
  const context = React65.useContext(CompoundComponentContext);
  if (context === null) {
  ...
  const [registeredId, setRegisteredId] = React65.useState(typeof id === "function" ? void 0 : id);
  useEnhancedEffect_default(() => {
    const {
      id: returnedId,
      deregister
...
function useMenuItem(params) {
  ...
  const {
    dispatch
  } = (_React$useContext = React66.useContext(DropdownContext_default)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted,
...
var _excluded28 = ["children", "disabled", "label", "slotProps", "slots"];
...
var MenuItem = React67.forwardRef(function MenuItem2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled: disabledProp = false,
...
var Option = React70.forwardRef(function Option2(props, forwardedRef) {
...
var Option_default = React70.memo(Option);
...
function useSelect(props) {
  ...
  const optionValues = React71.useMemo(() => Array.from(options.keys()), [options]);
  const getOptionByValue = React71.useCallback((valueToGet) => {
  ...
  const isItemDisabled = React71.useCallback((valueToCheck) => {
    var _option$disabled;
    const option = getOptionByValue(valueToCheck);
    return (_option$disabled = option == null ? void 0 : option.disabled) != null ? _option$disabled : false;
  }, [getOptionByValue]);
  const stringifyOption = React71.useCallback((valueToCheck) => {
    const option = getOptionByValue(valueToCheck);
    if (!option) {
      return "";
    }
  ...
  const getItemId = React71.useCallback((itemValue) => {
    var _options$get;
    return (_options$get = options.get(itemValue)) == null ? void 0 : _options$get.id;
  }, [options]);
  const handleSelectionChange = React71.useCallback((event, newValues) => {
    if (multiple) {
  ...
  const handleHighlightChange = React71.useCallback((event, newValue) => {
    onHighlightChange == null ? void 0 : onHighlightChange(event, newValue != null ? newValue : null);
  }, [onHighlightChange]);
  const handleStateChange = React71.useCallback((event, field, fieldValue) => {
    if (field === "open") {
  ...
  const getOptionMetadata = React71.useCallback((optionValue) => getOptionByValue(optionValue), [getOptionByValue]);
  ...
  const contextValue = React71.useMemo(() => _extends({}, listContextValue, compoundComponentContextValue), [listContextValue, compoundComponentContextValue]);
  let selectValue;
  if (props.multiple) {
...
var Select = React73.forwardRef(function Select2(props, forwardedRef) {
  ...
  const [buttonDefined, setButtonDefined] = React73.useState(false);
  ...
  const handleButtonRefChange = React73.useCallback((element) => {
  ...
  return (0, import_jsx_runtime40.jsxs)(React73.Fragment, {
    children: [(0, import_jsx_runtime39.jsx)(Button3, _extends({}, buttonProps, {
      children: renderValue(selectedOptionsMetadata)
    })), buttonDefined && (0, import_jsx_runtime39.jsx)(PopperComponent, _extends({}, popperProps, {
      children: (0, import_jsx_runtime39.jsx)(ListboxRoot, _extends({}, listboxProps, {
        children: (0, import_jsx_runtime39.jsx)(SelectProvider, {
          value: contextValue,
          children
        })
      }))
...
var Slider = React74.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime42.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime41.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime41.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min2 && mark.value <= max2).map((mark, index) => {
      ...
      return (0, import_jsx_runtime42.jsxs)(React74.Fragment, {
        children: [(0, import_jsx_runtime41.jsx)(Mark, _extends({
          "data-index": index
        ...
        })), mark.label != null ? (0, import_jsx_runtime41.jsx)(MarkLabel, _extends({
          "aria-hidden": true,
          "data-index": index
      ...
      return (0, import_jsx_runtime42.jsxs)(Thumb, _extends({
        "data-index": index
        ...
        children: [(0, import_jsx_runtime41.jsx)(Input3, _extends({
          "data-index": index,
          ...
          value: values2[index]
        }, inputProps)), ValueLabel ? (0, import_jsx_runtime41.jsx)(ValueLabel, _extends({}, !isHostComponent(ValueLabel) && {
          valueLabelFormat,
          index,
          disabled
        }, valueLabelProps, {
...
var Snackbar = React75.forwardRef(function Snackbar2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime43.jsx)(ClickAwayListener_default, _extends({}, clickAwayListenerProps, {
...
var Switch = React77.forwardRef(function Switch2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime45.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime44.jsx)(Track, _extends({}, trackProps)), (0, import_jsx_runtime44.jsx)(Thumb, _extends({}, thumbProps)), (0, import_jsx_runtime44.jsx)(Input3, _extends({}, inputProps))]
  }));
});
...
var TablePagination = React79.forwardRef(function TablePagination2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime48.jsx)(Root, _extends({}, rootProps, {
    children: (0, import_jsx_runtime49.jsxs)(Toolbar, _extends({}, toolbarProps, {
      ...
      })), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime48.jsx)(Select3, _extends({}, selectProps, {
...
var Context = React81.createContext(null);
if (true) {
...
function TabsProvider(props) {
  ...
  return (0, import_jsx_runtime50.jsx)(CompoundComponentContext.Provider, {
    value: compoundComponentContextValue,
    children: (0, import_jsx_runtime50.jsx)(TabsContext_default.Provider, {
...
var Tabs = React83.forwardRef(function Tabs2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime51.jsx)(TabsRoot, _extends({}, tabsRootProps, {
    children: (0, import_jsx_runtime51.jsx)(TabsProvider, {
      value: contextValue,
      children
    })
  }));
...
var TabPanel = React85.forwardRef(function TabPanel2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime52.jsx)(TabPanelRoot, _extends({}, tabPanelRootProps, {
...
var TabsList = React88.forwardRef(function TabsList2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime54.jsx)(TabsListProvider, {
    value: contextValue,
    children: (0, import_jsx_runtime54.jsx)(TabsListRoot, _extends({}, tabsListRootProps, {
      children
    }))
  });
});
...
var Tab = React90.forwardRef(function Tab2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime55.jsx)(TabRoot, _extends({}, tabRootProps, {
    children
  }));
});
true ? Tab.propTypes = {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-K2P4A3G4.js.map
